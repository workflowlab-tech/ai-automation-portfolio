    ...
    <div className="rounded-3xl border border-[var(--color-border)] bg-white p-6 shadow-sm sm:p-8">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-green-100 bg-[var(--color-accent-green-light)] p-4">
          ...
          <p className="mt-1 text-xs leading-5 text-[var(--color-body)]">Messenger service tools and store-owned social publishing stay connected to current product, shipping, and order data.</p>
        </div>
      </div>
    </div>
  );
